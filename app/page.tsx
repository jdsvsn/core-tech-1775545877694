...
const basePath = '/core-tech-1775545877694';
...
export default function Home() {
  ...
  const products = [{ n: 'Web Hosting', d: 'Our reliable and secure web hosting services provide fast and efficient access to your website, ensuring that your online presence is always available. With scalable plans to suit your business needs, you can trust us to keep your website running smoothly.', i: 'https://images.pexels.com/photos/17489152/pexels-photo-17489152.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Web Development', d: 'Our expert web development team creates custom websites that are visually stunning, user-friendly, and optimized for search engines, helping you establish a strong online presence and drive business growth.', i: 'https://images.pexels.com/photos/14553720/pexels-photo-14553720.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Mobile App Development', d: 'We design and develop mobile apps that are engaging, intuitive, and tailored to your business needs, helping you reach a wider audience and stay ahead of the competition.', i: 'https://images.pexels.com/photos/20694602/pexels-photo-20694602.png?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Domain Registration', d: 'Our domain registration services provide a simple and efficient way to secure your online identity, with a wide range of domain extensions available and competitive pricing.', i: 'https://images.pexels.com/photos/4160092/pexels-photo-4160092.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Consultation and Inquiries', d: 'Our consultation and inquiries service provides you with personalized guidance and support, helping you navigate the complex world of technology and make informed decisions about your business needs.', i: 'https://images.pexels.com/photos/7709227/pexels-photo-7709227.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Core Tech, we specialize in providing cutting-edge technology solutions to businesses and individuals in Kuching. Our team of experts is dedicated to delivering high-quality services that meet the unique needs of our clients. With a focus on innovation and customer satisfaction, we strive to be the go-to tech solution provider in the region.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To be the leading technology solutions provider in Kuching, known for our exceptional service and innovative approach to meeting the evolving needs of our clients.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver tailored technology solutions that exceed our clients\' expectations, while fostering a culture of innovation, customer satisfaction, and continuous improvement.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">We prioritize our customers\' needs, providing personalized support and ensuring that their satisfaction is at the forefront of everything we do.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">We stay ahead of the curve, embracing new technologies and trends to develop innovative solutions that drive business success and growth.</p>
                </div>
              </div>
            </div>
